...
Interchained Core version 0.19.1 is now available from:

  <https://interchainedcore.org/bin/interchained-core-0.19.1/>
...
From Interchained Core 0.17.0 onwards, macOS versions earlier than 10.10 are no
longer supported, as Interchained Core is now built using Qt 5.9.x which requires
macOS 10.10+. Additionally, Interchained Core does not yet change appearance when
...
- #17488 fix "interchainedd already running" warnings on macOS (fanquake)
