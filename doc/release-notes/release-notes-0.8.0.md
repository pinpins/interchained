Interchained-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/interchained/files/Interchained/interchained-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Interchained
...
New/changed settings (command-line or interchained.conf file)
--------------------------------------------------------
