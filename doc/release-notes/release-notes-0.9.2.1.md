Interchained Core version 0.9.2.1 is now available from:

  https://interchained.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 ITC to 0.01 ITC
...
- Fix "Start interchained on system login"
