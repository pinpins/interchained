Interchained version 0.5.4 is now available for download at:
http://sourceforge.net/projects/interchained/files/Interchained/interchained-0.5.4/
...
http://gitorious.org/interchained/interchainedd-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Interchained-Qt notifications under Growl 1.3.
Increase required age of Interchained-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxInterchained properly when installing Interchained-Qt over it. (Windows)
