Interchained Core version *0.15.1* is now available from:

  <https://interchainedcore.org/bin/interchained-core-0.15.1/>

or

  <https://interchained.org/bin/interchained-core-0.15.1/>
...
A number of changes to the way Interchained Core deals with peer connections and invalid blocks
...
- #11433 `e169349` Restore interchained-util-test py2 compatibility (MarcoFalke)
- #11308 `2e1ac70` zapwallettxes: Wait up to 3s for mempool reload (MarcoFalke)
- #10798 `716066d` test interchained-cli (jnewbery)
...
- #11125 `812c870` Add interchained-cli -stdin and -stdinrpcpass functional tests (promag)
- #11077 `1d80d1e` fix timeout issues from TestNode (jnewbery)
- #11078 `f1ced0d` Make p2p-leaktests.py more robust (jnewbery)
- #11210 `f3f7891` Stop test_interchained-qt touching ~/.interchained (MeshCollider)
...
### Miscellaneous
- #11377 `75997c3` Disallow uncompressed pubkeys in interchained-tx [multisig] output adds (TheBlueMatt)
