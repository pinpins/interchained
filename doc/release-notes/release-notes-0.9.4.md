Interchained Core version 0.9.4 is now available from:

  https://interchained.org/bin/0.9.4/
...
this update is incompatible with the Interchained system and could lead to consensus
forks.

Interchained Core released binaries from https://interchained.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~interchained/+archive/ubuntu/interchained
- A third-party or self-compiled Interchained Core

upgrade to Interchained Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
