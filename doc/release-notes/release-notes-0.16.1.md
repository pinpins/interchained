Interchained Core version 0.16.1 is now available from:

  <https://interchainedcore.org/bin/interchained-core-0.16.1/>
...
- #12843 `df38b13` Test starting interchainedd with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure interchainedd processes are cleaned up when tests end (sdaftuar)
