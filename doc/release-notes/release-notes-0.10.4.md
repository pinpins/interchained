Interchained Core version 0.10.4 is now available from:

  <https://interchained.org/bin/interchained-core-0.10.4/>
...
- #6953 `43c2789` Split interchained-tx into its own package
- #6953 `dfe0d4d` Include interchained-tx binary on Debian/Ubuntu
