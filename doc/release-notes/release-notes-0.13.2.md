Interchained Core version 0.13.2 is now available from:

  <https://interchained.org/bin/interchained-core-0.13.2/>
...
- #8908 `4a974b2` Update interchained-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow interchained-tx to create v2 transactions (itcdrak)
