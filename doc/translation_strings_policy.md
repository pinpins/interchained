...
This document provides guidelines for internationalization of the Interchained Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `interchained_en.ts` remains unchanged.
