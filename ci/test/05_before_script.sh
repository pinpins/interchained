...
if [ "$CI_OS_NAME" == "macos" ]; then
  echo > $HOME/Library/Application\ Support/Interchained
else
  DOCKER_EXEC echo \> \$HOME/.interchained
fi
...
if [[ ${USE_MEMORY_SANITIZER} == "true" ]]; then
  ...
  # from depends. See https://github.com/interchained/interchained/pull/18288#discussion_r433189350 for
  # details.
