...
# Deterministically build Interchained Core for HOSTs (overridable by environment)
...
for host in ${HOSTS=x86_64-linux-gnu arm-linux-gnueabihf aarch64-linux-gnu riscv64-linux-gnu x86_64-w64-mingw32}; do
    ...
    (
        ...
        #     same exact path (e.g. mapping '/home/satoshi/interchained/' to
        #     '/home/satoshi/interchained/'). This means that the $PWD inside the
        ...
        #                      according to SPEC
        #
        #   --share="$PWD"=/interchained
        #
        #                     maps our current working directory to /interchained
        ...
        #     container so that we have something to build. '/interchained' was
        #     chosen arbitrarily.
        #
        ...
        time-machine environment --manifest="${PWD}/contrib/guix/manifest.scm" \
                                 ...
                                 -- env HOST="$host" \
                                      ...
                                      bash -c "cd /interchained && bash contrib/guix/libexec/build.sh"
    )
