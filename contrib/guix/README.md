# Bootstrappable Interchained Core Builds

This directory contains the files necessary to perform bootstrappable Interchained
Core builds.
...
- 24GB of free disk space on the partition that the Interchained Core git repository
  resides in
...
For a Interchained Core depends development environment, simply invoke
...
From the top of a clean Interchained Core repository:
...
To use dongcarl's substitute server for Interchained Core builds after having
