...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the interchained repository."
  exit 1
fi
...
# See https://github.com/interchained/interchained/issues/16064
...
echo 'When compiling interchainedd, run `./configure` in the following way:'
echo
