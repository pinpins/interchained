 ...
 */
static const unsigned int MAX_OP_RETURN_RELAY = 300;
 ...
 *  A CTxDestination is the internal data type encoded in a interchained address
 */
...
/**
 * Generate a Interchained scriptPubKey for the given CTxDestination. Returns a P2PKH
