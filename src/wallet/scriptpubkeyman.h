// Copyright (c) 2019-2020 The Interchained Core developers
 ...
 * change.
 *
 * The Interchained Core wallet was originally a collection of unrelated private
...
public:
    ...
    virtual SigningResult SignMessage(const std::string& message, const WitnessV0KeyHash& wpkh, std::string& str_sig) const { return SigningResult::SIGNING_FAILED; }
...
public:
    ...
    SigningResult SignMessage(const std::string& message, const WitnessV0KeyHash& wpkh, std::string& str_sig) const override;
