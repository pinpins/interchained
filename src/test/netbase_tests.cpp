...
{
    BOOST_CHECK(TestSplitHost("www.interchainedcore.org", "www.interchainedcore.org", -1));
    BOOST_CHECK(TestSplitHost("[www.interchainedcore.org]", "www.interchainedcore.org", -1));
    BOOST_CHECK(TestSplitHost("www.interchainedcore.org:80", "www.interchainedcore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.interchainedcore.org]:80", "www.interchainedcore.org", 80));
