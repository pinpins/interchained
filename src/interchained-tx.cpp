...
static void SetupInterchainedTxArgs(ArgsManager &argsman)
{
...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " interchained-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  interchained-tx [options] <hex-tx> [commands]  Update hex-encoded interchained transaction\n" +
            "or:     interchained-tx [options] -create [commands]   Create hex-encoded interchained transaction\n" +
            "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded interchained transaction
