    ...
    mapper(nullptr)
{
    ...
    ui->interchainedAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->interchainedAtStartup);
    ...
    ui->interchainedAtStartup->setToolTip(ui->interchainedAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->interchainedAtStartup->setText(ui->interchainedAtStartup->text().arg(PACKAGE_NAME));

    ui->openInterchainedConfButton->setToolTip(ui->openInterchainedConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new InterchainedUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->interchainedAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openInterchainedConfButton_clicked()
{
    ...
    if (!GUIUtil::openInterchainedConf())
