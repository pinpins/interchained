    ...
    if(role == Qt::DisplayRole || role == Qt::EditRole)
    {
        ...
        case Amount:
            if (rec->recipient.amount == 0 && role == Qt::DisplayRole)
                ...
                return InterchainedUnits::format(walletModel->getOptionsModel()->getDisplayUnit(), rec->recipient.amount, false, InterchainedUnits::SeparatorStyle::NEVER);
            else
                return InterchainedUnits::format(walletModel->getOptionsModel()->getDisplayUnit(), rec->recipient.amount);
        }
    }
...
{
    return (this->walletModel->getOptionsModel() != nullptr) ? tr("Requested") + " ("+InterchainedUnits::shortName(this->walletModel->getOptionsModel()->getDisplayUnit()) + ")" : "";
}
