...
//! Entry point for InterchainedApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &InterchainedApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for InterchainedGUI tests.
void AppTests::guiTests(InterchainedGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &InterchainedGUI::consoleShown, this, &AppTests::consoleTests);
