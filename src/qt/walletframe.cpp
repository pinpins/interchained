...
WalletFrame::WalletFrame(const PlatformStyle* _platformStyle, InterchainedGUI* _gui)
    : QFrame(_gui),
      gui(_gui),
...
bool WalletFrame::addWallet(WalletModel *walletModel)
{
    ...
    connect(walletView, &WalletView::transactionClicked, gui, &InterchainedGUI::gotoHistoryPage);
    connect(walletView, &WalletView::coinsSent, gui, &InterchainedGUI::gotoHistoryPage);
    connect(walletView, &WalletView::message, [this](const QString& title, const QString& message, unsigned int style) {
        gui->message(title, message, style);
    });
    connect(walletView, &WalletView::encryptionStatusChanged, gui, &InterchainedGUI::updateWalletStatus);
    connect(walletView, &WalletView::incomingTransaction, gui, &InterchainedGUI::incomingTransaction);
    connect(walletView, &WalletView::hdEnabledStatusChanged, gui, &InterchainedGUI::updateWalletStatus);
    connect(gui, &InterchainedGUI::setPrivacy, walletView, &WalletView::setPrivacy);
