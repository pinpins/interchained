    ...
    platformStyle(_platformStyle)
{
    ...
    // normal interchained address field
    GUIUtil::setupAddressWidget(ui->payTo, this);
    // just a label for displaying interchained address(es)
    ui->payTo_is->setFont(GUIUtil::fixedPitchFont());

    // Connect signals
    connect(ui->payAmount, &InterchainedAmountField::valueChanged, this, &SendCoinsEntry::payAmountChanged);
