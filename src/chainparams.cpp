...
public:
    CMainParams() {
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x00000000ed361749ae598d60cd78395eb526bc90f5e1198f0b045f95cecc80c8"));
        ...
        checkpointData = {
            {
                {0, uint256S("0x00000000ed361749ae598d60cd78395eb526bc90f5e1198f0b045f95cecc80c8")},
                {1, uint256S("0x000000002dd5fba06cc39452f6ddb23c754d2171818759fc08bc3101bd717810")}
            }
        };
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.interchained.jonasschnelli.ch");
        vSeeds.emplace_back("seed.titc.petertodd.org");
        vSeeds.emplace_back("seed.testnet.interchained.sprovoost.nl");
