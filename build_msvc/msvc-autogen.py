...
libs = [
    'libinterchained_cli',
    'libinterchained_common',
    'libinterchained_crypto',
    'libinterchained_server',
    'libinterchained_util',
    'libinterchained_wallet_tool',
    'libinterchained_wallet',
    'libinterchained_zmq',
    'bench_interchained',
    'libtest_util',
]
...
def main():
    parser = argparse.ArgumentParser(description='Interchained-core msbuild configuration initialiser.')
        ...
        with open(vcxproj_filename + '.in', 'r', encoding='utf-8') as vcxproj_in_file:
            with open(vcxproj_filename, 'w', encoding='utf-8') as vcxproj_file:
                vcxproj_file.write(vcxproj_in_file.read().replace(
                    '@SOURCE_FILES@\n', content))
    copyfile(os.path.join(SOURCE_DIR,'../build_msvc/interchained_config.h'), os.path.join(SOURCE_DIR, 'config/interchained-config.h'))
