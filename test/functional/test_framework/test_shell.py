...
class TestShell:
    """Wrapper Class for InterchainedTestFramework.

    The TestShell class extends the InterchainedTestFramework
    ...
    class __TestShell(InterchainedTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by InterchainedTestFramework child class.
            self.num_nodes = 1
