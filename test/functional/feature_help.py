...
"""Verify that starting interchained with -h works as expected."""

from test_framework.test_framework import InterchainedTestFramework
from test_framework.util import assert_equal

class HelpTest(InterchainedTestFramework):
    ...
    def run_test(self):
        self.log.info("Start interchained with -h for help text")
        ...
        self.log.info("Start interchained with -version for version information")
        ...
        self.log.info("Start interchainedd with -fakearg to make sure it does not start")
