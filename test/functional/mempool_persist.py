...
By default, interchainedd will dump mempool on shutdown and
...
class MempoolPersistTest(InterchainedTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent interchainedd from writing mempool.dat to disk. Verify that `savemempool` fails")
