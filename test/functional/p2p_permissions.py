...
class P2PPermissionsTests(InterchainedTestFramework):
    ...
    def replaceinconfig(self, nodeid, old, new):
        with open(self.nodes[nodeid].interchainedconf, encoding="utf8") as f:
            newText = f.read().replace(old, new)
        with open(self.nodes[nodeid].interchainedconf, 'w', encoding="utf8") as f:
            f.write(newText)
