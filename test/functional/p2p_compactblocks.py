...
# TestP2PConn: A peer we use to send messages to interchainedd, and store responses.
...
class CompactBlocksTest(InterchainedTestFramework):
    ...
    # This test actually causes interchainedd to (reasonably!) disconnect us, so do this last.
    ...
    # interchainedd's choice of nonce.
    ...
    # Test that interchainedd requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, test_node):
        ...
        # Note that it's possible for interchainedd to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, test_node):
        version = test_node.cmpct_version
        node = self.nodes[0]
        # interchainedd will not send blocktxn responses for blocks whose height is
