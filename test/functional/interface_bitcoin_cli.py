...
# The block reward of coinbaseoutput.nValue (50) ITC/block matures after
# COINBASE_MATURITY (100) blocks. Therefore, after mining 101 blocks we expect
# node 0 to have a balance of (BLOCKS - COINBASE_MATURITY) * 50 ITC/block.
BLOCKS = 101
...
class TestInterchainedCli(InterchainedTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getblockchaininfo RPC and `interchained-cli getblockchaininfo`")
        ...
        if self.is_wallet_compiled():
            self.log.info("Test -getinfo and interchained-cli getwalletinfo return expected wallet info")
            ...
            # Mine a block to confirm; adds a block reward (50 ITC) to the default wallet.
            ...
            # Test interchained-cli -generate.
            n1 = 3
            n2 = 4
            ...
            # Test interchained-cli -generate with -rpcwallet in multiwallet mode.
