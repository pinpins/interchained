...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the InterchainedTestFramework
    pass


class ExampleTest(InterchainedTestFramework):
    # Each functional test is a subclass of the InterchainedTestFramework class.
    ...
    def custom_method(self):
        ...
        InterchainedTestFramework class so other tests can use it."""
